...
def _min_mc_prob() -> float:
    return cfg.min_mc_prob
...
def _rsi_overbought() -> float:
    return cfg.rsi_overbought


def _rsi_oversold() -> float:
    return cfg.rsi_oversold


def _min_score_choppy() -> float:
    return cfg.min_score_choppy


def _fixed_max_pct() -> float:
    return cfg.sl_max_pct
